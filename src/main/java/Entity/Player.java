...
public class Player extends MapObject {
        ...
        try {
            ...
            for(int i = 0; i< 7; i++) {
                ...
                for (int j = 0; j < numFrames[i]; j++) {
                    ...
                    if(i == 2){
                        bi[j] = spritesheet.getSubimage(0, 64, 36, height);
                    }
                    if(i == 3){
                        bi[j] = spritesheet.getSubimage(0, 96, 38, height);
                    }
                    if(i == 4){
                        bi[j] = spritesheet.getSubimage(j*48, 128, 48, 28);
                    }
                    if(i == 5){
                        bi[j] = spritesheet.getSubimage(j*52, 156, 52, 36);
                    }
                    if(i == 6) {
    ...
    private void getNextPosition(){
        ...
        // cannot move while attack, except in air
