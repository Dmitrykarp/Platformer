...
public class Help3State extends GameState {
    ...
    public void init() {
       ...
       try {
           bg = new Background("/Backgrounds/helpbg3.gif",0);
    ...
    private void checkButton(){
        if (currentChoise == 0){
            ...
            homebutton.setVector(0, 0);
            homebutton.setPosition(147, 181);
            rightbutton = new Background(sprites.get(1)[2]);
            rightbutton.setVector(0, 0);
            rightbutton.setPosition(179, 181);
    ...
    public void keyPresed(int k) {
        ...
        if(k == KeyEvent.VK_RIGHT){
            if (currentChoise < 2)currentChoise++;
            if (currentChoise == 2) currentChoise = 1;
        }
